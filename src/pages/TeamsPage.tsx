...
// //     <motion.section initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.8, ease: 'easeOut' }} className={className}>
// //         {children}
// //     </motion.section>
// // );
...
// //                 .from('teams')
// //                 .select('id, name_en, name_zh_hant, description_en, description_zh_hant, team_members(position, profiles(english_name, avatar_url))')
// //                 .eq('is_active', true)
...
// //                     <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-4xl md:text-6xl font-extrabold text-text-primary">{t('teams.pageTitle')}</motion.h1>
// //                     <motion.p initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="mt-4 text-lg md:text-xl text-text-secondary">{t('teams.pageSubtitle')}</motion.p>
// //                 </div>
// //             </section>
...
// //                                     <p className="text-text-secondary mt-2 max-w-2xl mx-auto">{teamDescription}</p>
// //                                 </div>
...
//             const { data, error } = await supabase
//                 .from('teams')
//                 .select('id, name_en, name_zh_hant, description_en, description_zh_hant, team_members(position_en, position_zh_hant, profiles(english_name, avatar_url))')
//                 .eq('is_active', true)
//                 .order('name_en', { ascending: true });
//             if (error) throw new Error(error.message);
//             return data;
