...
const CmsLayout = () => {
    const navLinkClasses = ({ isActive }: { isActive: boolean }) => `block px-4 py-2 rounded-md text-sm ${isActive ? 'bg-primary text-white' : 'text-neutral-800 hover:bg-neutral-100'}`;
    return (
        <div className="flex min-h-screen">
            <aside className="w-64 bg-white p-4 border-r border-neutral-200 flex-shrink-0">
                <h2 className="text-xl font-bold mb-4 text-neutral-800">CMS Menu</h2>
            ...
            <main className="flex-1 p-6 bg-neutral-100 overflow-y-auto"><Outlet /></main>
        </div>
    );
};
