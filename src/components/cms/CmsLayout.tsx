...
const CmsLayout = () => {
    const navLinkClasses = ({ isActive }: { isActive: boolean }) =>
        `block px-4 py-2 rounded-md text-sm ${isActive ? 'bg-primary text-white' : 'text-neutral-800 hover:bg-neutral-100'
        }`;

    return (
        <div className="flex">
            <aside className="w-64 bg-white p-4 border-r border-neutral-200">
